...
<div style="padding: 2%;">
    <div style="background-color: #ffffff;border-top: 5px solid #19AB8E;">
        <div style="padding: 20px;">
            ...
            <?= Adm::t('oplata/overdue', "Hi {username}({email})<br/>Invoice: #{order_id}", ['order_id' => $model->id, 'username' => $username, 'email' => $model->email]) ?>
            </div>

            <table class="text-color2" style="width: 100%;">
                <tr>
                    <td style="width: 50%;"><?= Adm::t('oplata/overdue', "From:") ?></td>
                    <td><?= Adm::t('oplata/overdue', "domain.com") ?></td>
                </tr>
                <tr>
                    <td style="width: 50%;"><?= Adm::t('oplata/overdue', "To:") ?></td>
                    <td><?= $model->email ?></td>
                </tr>
                <tr>
                    <td style="width: 50%;"><?= Adm::t('oplata/overdue', "Price:") ?></td>
                    <td>
                ...
                <tr>
                    <td style="width: 50%;"><?= Adm::t('oplata/overdue', "Created:") ?></td>
                    <td><?=Yii::$app->formatter->asDatetime($model->created_at) ?></td>
                </tr>
                <tr>
                    <td style="width: 50%;"><?= Adm::t('oplata/overdue', "Payment day:") ?></td>
                    <td><?=Yii::$app->formatter->asDatetime($model->date_end) ?></td>
                </tr>
                <tr>
                    <td style="width: 50%;"><?= Adm::t('oplata/overdue', "Title:") ?></td>
                    <td><?= $model->title ?></td>
                </tr>
            </table>
            ...
            <div style="text-align: center; padding: 10px 0px;">
                <a class="text-font3" href="<?= Url::to(['default/invoice', 'alias' => $model->alias], true) ?>" style="background: none repeat scroll 0 0 #88ad09;color: white;display: inline-block;padding: 8px 20px;text-decoration: none;">
                    <?= Adm::t('oplata/overdue', "Pay") ?>
                </a>
            </div>

            <div class="text-font" style="margin: 10px 0px;">
                <?= Adm::t('oplata/overdue', "Link: {url}", ['url' => Url::to(['default/invoice', 'alias' => $model->alias], true)]) ?>
            </div>
        </div>
